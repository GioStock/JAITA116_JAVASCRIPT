...
class Docente extends Persona{
    constructor(nome,cognome,eta,genere,interessi,materia){
        //super richiama le proprietà ereditate dal genitore constentendo di fare riferimento alla superclasse.
    ...
    presentati(){
        console.log(`Buongiorno, sono ${this.nome} ${this.cognome} è sarò ${(this.genere=='Maschio') ? 'il vostro':'la vostra'} docente di ${this.materia}. `);
    }
